...
function Library:Notify(options, callback)
	...
	function Notification:GetHeight()
		...
		return 42 + math.round(TXS:GetTextSize(desc.Text, 14, Enum.Font.Arial, Vector2.new(desc.AbsoluteSize.X, Library.Settings.MaxNotifStacking * 14)).Y + 0.5)
	end
		...
		function Tab:AddSection(name, options)
			...
			function Section:AddBind(name, bind, options, callback)
				...
				function Bind:Set(bind)
					...
					Bind.Frame.Holder.Bind.Size = UDim2.new(0, math.max(12 + math.round(TXS:GetTextSize(bind.Name, 14, Enum.Font.Arial, Vector2.new(9e9)).X + 0.5), 42), 0, 26)
			...
			function Section:AddPicker(name, options, callback)
				...
				function Picker:Set(h, s, v)
					...
					Picker.Frame.Holder.Top.Selected.Size = UDim2.new(0, math.round(TXS:GetTextSize(Picker.Frame.Holder.Top.Selected.Display.Text, 16, Enum.Font.Arial, Vector2.new(9e9)).X + 0.5) + 20, 0, 26)
